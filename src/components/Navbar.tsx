...
import { PlatformContextBadge } from '@/components/platform-manager/PlatformContextBadge';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                  ...
                  {/* Tenant Admin Section */}
                    ...
                    {isSuperAdmin && (
                      <>
                        ...
                        <DropdownMenuItem asChild>
                          <Link to="/app/platform-control" className="flex items-center cursor-pointer">
